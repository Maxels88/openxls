...
public class FormatHandle implements Handle, FormatConstants
{
	...
	private org.openxls.formats.XLS.WorkBook wkbook;
	 ...
	 */
	public FormatHandle( org.openxls.formats.XLS.WorkBook book, int xfnum )
	{
		wkbook = book;
	 ...
	 * @param bk
	 */
	public void setWorkBook( org.openxls.formats.XLS.WorkBook bk )
	{
		wkbook = bk;
	}
...
// not used anymore		canModify = true; // if duplicated, it's new and unlinked (thus far)
	 ...
	 * @return
	 */
	public static Xf cloneXf( Xf xf, org.openxls.formats.XLS.WorkBook wkbook )
	{
		Xf clone = new Xf( xf.getFont().getIdx(), wkbook );
		byte[] data = xf.getBytesAt( 0, xf.getLength() - 4 );
		clone.setData( data );
	 ...
	 * @return
	 */
	public static Xf cloneXf( Xf xf, Font f, org.openxls.formats.XLS.WorkBook wkbook )
	{
