...
import org.openxls.formats.XLS.AutoFilter;
...
import org.openxls.formats.XLS.Colinfo;
...
import org.openxls.formats.XLS.FeatHeadr;
...
import org.openxls.formats.XLS.Password;
import org.openxls.formats.XLS.ReferenceTracker;
import org.openxls.formats.XLS.Row;
import org.openxls.formats.XLS.RowNotFoundException;
import org.openxls.formats.XLS.SheetProtectionManager;
...
public class WorkSheetHandle implements Handle
{
	...
	private org.openxls.formats.XLS.WorkBook mybook;
	WorkBookHandle wbh;
	...
	protected WorkSheetHandle( Boundsheet sht, WorkBookHandle b )
	{
		...
		String shiftRule = (String) System.getProperties().get( "org.openxls.extenXLS.WorkSheetHandle.shiftInclusive" );
		...
		if( System.getProperty( "org.openxls.ExtenXLS.cacheCellHandles" ) != null )
		{
			cache = Boolean.valueOf( (System.getProperty( "org.openxls.ExtenXLS.cacheCellHandles" )) );
		}
	}
	 ...
	 * @param address
	 * @param d
	 * @throws org.openxls.formats.XLS.CellNotFoundException is
	 ...
	 * @throws org.openxls.formats.XLS.CellNotFoundException is thrown if there is no existing Cell at the specified address.
	 */
	 ...
	 * "{@code org.openxls.extenxls.csvdelimiter}".
	 */
	public void readCSV( BufferedReader input ) throws IOException
	{
		int rws = 0;
		String field_delimiter = System.getProperty( "org.openxls.extenxls.csvdelimiter", "," );
