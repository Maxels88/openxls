...
import org.openxls.formats.OOXML.Layout;
import org.openxls.formats.OOXML.OOXMLConstants;
import org.openxls.formats.OOXML.SpPr;
import org.openxls.formats.OOXML.Title;
import org.openxls.formats.OOXML.TwoCellAnchor;
import org.openxls.formats.OOXML.TxPr;
...
import org.openxls.formats.XLS.charts.ChartConstants;
import org.openxls.formats.XLS.charts.ChartType;
...
import org.openxls.formats.OOXML.Legend;
...
//        	PtgRef pr= (PtgRef)refs[i];
  ...
  */
	 ...
	 * set the font for the Chart Title
	 *
	 * @param org.openxls.Formats.XLS.Font f - desired font for the Chart Title
	 * @see Font
	 */
	 ...
	 *
	 * @return org.openxls.Formats.XLS.Font
	 * @see Font
	 */
	 ...
	 * set the font for all axes on the Chart
	 *
	 * @param org.openxls.Formats.XLS.Font f - desired font for the Chart axes
	 * @see Font
	 */
	 ...
	 *
	 * @return org.openxls.Formats.XLS.Font for Chart Axes or null if no axes
	 * @see Font
	 */
...
/* TODO: NEEDED??	public boolean setLocationLocked(String loc, boolean l){
	 ...
	 * @throws org.openxls.formats.XLS.CellNotFoundException
	 */
 ...
 */
					...
					else if( tnm.equals( "legend" ) )
					{
						...
						thischart.ooxmlLegend = (Legend) Legend.parseOOXML( xpp, lastTag, wbh )
						                                                                                               .cloneElement();
