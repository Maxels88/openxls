	...
	public void adjustParameterIds()
	{
		...
		switch( iftab )
		{
			case FunctionConstants.xlfVlookup:
				setParameterType( 0, VALUE );
				setParameterType( 1, REFERENCE );
				setParameterType( 2, VALUE );
				setParameterType( 3, VALUE );
				break;
			case FunctionConstants.xlfColumn:
			case FunctionConstants.XLF_ROW:
				setParameterType( 0, REFERENCE );
				break;
			case FunctionConstants.xlfIndex:
				setParameterType( 0, REFERENCE );
				setParameterType( 1, VALUE );
				break;
			case FunctionConstants.XLF_SUM_IF:
				setParameterType( 0, REFERENCE );
				break;
			case FunctionConstants.xlfSumproduct:
				setParameterType( 0, ARRAY );
				setParameterType( 1, ARRAY );
				break;
			default:
				break;
		}
