...
import org.openxls.formats.LEO.BIGBLOCK;
import org.openxls.formats.LEO.Block;
import org.openxls.formats.LEO.LEOFile;
import org.openxls.formats.LEO.Storage;
import org.openxls.formats.XLS.charts.ChartObject;
...
/*        if(rec instanceof Mulled) {
	...
	public StringBuffer writeOut( OutputStream out )
	{
		...
		if( System.getProperties().get( "org.openxls.ExtenXLS.autocreatelockdown" ) != null )
		{
			lockit = System.getProperties().get( "org.openxls.ExtenXLS.autocreatelockdown" ).equals( "true" );
		}
