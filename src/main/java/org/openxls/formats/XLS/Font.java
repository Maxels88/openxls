...
public final class Font extends XLSRecord implements FormatConstants
{
	...
	// OOXML specifics:
	private org.openxls.formats.OOXML.Color customColor = null; // holds custom color (OOXML or other use)
	...
	public void setColor( java.awt.Color color )
	{
		...
		{
			customColor = new org.openxls.formats.OOXML.Color( color, "color", getWorkBook().getTheme() );
		}
	...
	public void setColor( String clr )
	{
		...
		{
			customColor = new org.openxls.formats.OOXML.Color( clr, "color", getWorkBook().getTheme() );
		}
		icv = (short) customColor.getColorInt();
		byte[] newcl = ByteTools.shortToLEBytes( icv );
		System.arraycopy( newcl, 0, data, 4, 2 );
	...
	public String getXML( boolean convertToUnicodeFont )
	{
		...
		if( getUnderlineStyle() != STYLE_UNDERLINE_NONE )
		{
	 ...
	 * @param c
	 */
	public void setOOXMLColor( org.openxls.formats.OOXML.Color c )
	{
		if( c != null )
		{
	 ...
	 * @return
	 */
	public org.openxls.formats.OOXML.Color getOOXMLColor()
	{
		return customColor;
	}
	...
	public String getOOXML()
	{
		...
		org.openxls.formats.OOXML.Color c = getOOXMLColor();
		if( c != null )
		{
	...
	{
		org.openxls.formats.OOXML.Color c = null;
		String sz = null;
		String name = "";
		Object u = null;
		boolean b = false;
		...
		try
		{
			...
			while( eventType != XmlPullParser.END_DOCUMENT )
			{
				if( eventType == XmlPullParser.START_TAG )
				{
					...
					{
						c = (org.openxls.formats.OOXML.Color) org.openxls.formats.OOXML.Color.parseOOXML( xpp, FormatHandle.colorFONT, bk );
					}
				}
